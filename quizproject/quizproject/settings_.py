...
ADMINS = (
    #('Martin Hallen', 'marthall@outlook.com'),
)
...
DATABASES = {
    'default': {
        ...
        # 'NAME': os.path.join(DIRPATH, '../db/database.db'),
        'NAME': '/Users/peterholiman/Documents/NTNU-IT S2013/quizproject/db/database.db',
...
SECRET_KEY = '2!il0%(k_z_!n$+g=wl9!f=%873&_ie=8qx)93x2#ug20g%-=p'
